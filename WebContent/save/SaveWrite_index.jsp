...
%>
	...
	//마이페이지에서 수정 눌렀을때 페이지이동
	function firstSeller_tab(){
			$(".write_top_cont").html("제작자 정보");
			$(".write_content").load("./save/SaveWrite_seller.jsp");
	}

	//상품소개 저장했을때 페이지 받아오기
	function SaveBoard_tab(){
		$(".write_top_cont").html("프로젝트 소개");
		$(".write_content").load("./save/SaveWrite_board.jsp");
	}
	//리워드저장했을때
	function SaveReward_tab(){
		$(".write_top_cont").html("리워드 옵션");
		$(".write_content").load("./save/SaveWrite_reward.jsp");
	}
