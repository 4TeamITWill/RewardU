...
<title>Insert title here</title>
	...
	<script type="text/javascript">
			...
			function change(){
				...
				if(select == "all"){
					window.open("./PermitListcategory.ad?&category=전자&order="+order,'_self');
				}else{
					window.open("./PermitListcategory.ad?&category=전자&select="+select+"&order="+order,'_self');	
				}
		...
		<tr id="loadmore">
			<td colspn="5">
				<div id="more" class="btns">
					...
					<input type="hidden" name="opt" id="opt" value="${param.select }"/>
					<input type="hidden" name="opt" id="opt" value="${param.category }"/>
