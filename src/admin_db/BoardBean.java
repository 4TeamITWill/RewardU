...
public class BoardBean {
	...
	public int getPd_opprice1() {
		return pd_opprice1;
	}
	public void setPd_opprice1(int pd_opprice1) {
		this.pd_opprice1 = pd_opprice1;
	}
	public int getPd_opprice2() {
		return pd_opprice2;
	}
	public void setPd_opprice2(int pd_opprice2) {
		this.pd_opprice2 = pd_opprice2;
	}
	public int getPd_opprice3() {
		return pd_opprice3;
	}
	public void setPd_opprice3(int pd_opprice3) {
	...
	public Timestamp getPd_end() {
		return pd_end;
	}
	public void setPd_end(Timestamp pd_end) {
		this.pd_end = pd_end;
	}
